...
Contextualization:
* Selecting *Apply contextualization* applies spatial contextualization to the list of training rasters by computing local statistics and principal components over a square moving window.
